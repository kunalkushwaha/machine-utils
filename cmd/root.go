...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.machine-utils.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".machine-utils") // name of config file (without extension)
